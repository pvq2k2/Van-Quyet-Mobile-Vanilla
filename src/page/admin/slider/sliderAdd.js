...
import SliderAdminPage from ".";
import { addSlider } from "../../../api/sliders";
...
const SliderAdd = {
    print() {
        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between">
          ...
          <a href="/admin/sliders" class="sm:ml-3">
        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
          <form action="#" id="form-add-slider" method="POST">
    ...
    afterRender() {
        const formAdd = document.querySelector("#form-add-slider");
        ...
        const CLOUDINARY_PRESET = "imgslider";
        ...
        formAdd.addEventListener("submit", async (e) => {
            ...
            try {
                const { data } = await addSlider({
                    img: response.data.url,
                });
                if (data) {
                    toastr.success("Add slider successfully!");
                    setTimeout(() => {
